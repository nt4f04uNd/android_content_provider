...
// https://cs.android.com/android/platform/superproject/+/master:frameworks/base/core/java/android/database/MatrixCursor.java
//
// List of changes:
// - Added a contructor DataMatrixCursor(String[] columnNames, Object[] data, int rowCount)
// - Added comment
// - Suppress mPos deprecation warnings
//
...
/**
 * A copy of Android's [MatrixCursor], but with ability to create
 * it from the data, typically received from the Dart.
 *
 * A mutable cursor implementation backed by an array of {@code Object}s. Use
 * {@link #newRow()} to add rows. Automatically expands internal capacity
 * as needed.
 */
public class DataMatrixCursor extends AbstractCursor {
    ...
    /**
     * Creates the cursor from data, typically received from Dart.
     */
    public DataMatrixCursor(String[] columnNames, Object[] data, int rowCount) {
        if (data.length < columnNames.length * rowCount) {
            throw new IllegalArgumentException("Data size doesn't fit rowCount and columnCount: " +
                    data.length + " < " + columnNames.length * rowCount);
        }
     ...
     */
    public DataMatrixCursor(String[] columnNames, int initialCapacity) {
        this.columnNames = columnNames;
     ...
     *  determines column ordering elsewhere in this cursor
     */
    public DataMatrixCursor(String[] columnNames) {
        this(columnNames, 16);
    }
    ...
    /** A copy of a hidden DatabaseUtils.getTypeOfObject. */
